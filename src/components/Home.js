    ...
    <HomeContainer>
        ...
        <ProductContainer>
            <div className="grid_container">
              <div className="product_info1"><Product title="The Lean Startup: How Today's Entrepreneurs Use Continuous Innovation to Create Radically Successful Businesses" price="13.01" stars="3" img="https://images-na.ssl-images-amazon.com/images/I/51T-sMqSMiL._AC_SY780_.jpg" alt="the lean startup books" /></div>
